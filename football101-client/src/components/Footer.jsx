...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-slate-900 border-t border-slate-700 py-12 px-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="border border-slate-600 text-slate-400 hover:bg-slate-700 hover:text-white hover:border-blue-500 bg-transparent px-3 py-2 rounded text-sm transition-colors flex items-center gap-2"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="border border-slate-600 text-slate-400 hover:bg-slate-700 hover:text-white hover:border-purple-500 bg-transparent px-3 py-2 rounded text-sm transition-colors flex items-center gap-2"
              >
