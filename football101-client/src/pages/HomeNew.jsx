...
//                 <br />
//                 - League Management: Create and manage leagues, view standings.
//                 <br />
//                 - Team Management: Add teams, view player lineups.
//                 <br />
//                 - Upcoming Features: Real Time match updates, player statistics, and more.
...
//               </p> */}
//               <p className="text-slate-300 text-lg leading-relaxed">
//                 Existing League Leaderboards : 
//                 <br />
//                 Premier league, Bundesliga, La Liga.
//                 <br />
//                 <br />
//                 Existing Team Lineups : 
//                 <br />
//                 Top 5 PL finishers in 2024/2025 season.
//                 <br />
...
import { useRef } from "react"
import { Link } from "react-router-dom"
import { FaUsers, FaTrophy, FaBullseye, FaArrowRight, FaFutbol, FaImage } from "react-icons/fa"
...
const features = [
  ...
  },
  {
    ...
    hoverColor: "hover:shadow-gray-600/20",
  },
  {
    title: "Match",
    path: "/match",
  ...
  },
  {
    ...
    hoverColor: "hover:shadow-gray-800/20",
  }
]
...
export default function Home() {
  ...
  return (
    <div className="w-full bg-gradient-to-br from-black via-gray-900 to-black text-slate-100 min-h-screen">
      {/* Enhanced Hero Section */}
      <section className="py-32 px-6 text-center relative overflow-hidden">
        {/* Background Image Placeholder */}
        <div className="absolute inset-0 bg-gray-900/80">
          {/* Replace this div with your background image */}
          <div className="w-full h-full bg-gradient-to-br from-gray-800 via-gray-900 to-black opacity-50 flex items-center justify-center">
            <img
              src={homeImage} // Placeholder image path
              alt="Background"
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <div className="w-20 h-20 rounded-full bg-gradient-to-r from-gray-700 to-black flex items-center justify-center mx-auto mb-8 shadow-2xl border border-gray-600">
            <FaTrophy className="h-10 w-10 text-white" />
          </div>

          <h1 className="text-6xl md:text-7xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-white via-gray-300 to-gray-400 mb-6 leading-tight">
            Football101
          </h1>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <button
              onClick={() => scrollTo(aboutRef)}
              className="bg-gray-800 hover:bg-gray-700 border border-gray-600 text-white px-8 py-4 text-lg font-semibold shadow-lg hover:shadow-gray-500/25 transition-all duration-300 rounded-lg flex items-center justify-center gap-2"
            >
              Learn More
              <FaArrowRight className="h-5 w-5" />
            </button>
            <button
              onClick={() => scrollTo(exploreRef)}
              className="border border-gray-600 text-gray-300 hover:bg-gray-800 hover:text-white px-8 py-4 text-lg font-semibold transition-all duration-300 rounded-lg bg-transparent"
            >
              Explore Features
            </button>
          </div>
      ...
      {/* Enhanced About Section */}
      <section ref={aboutRef} className="py-24 px-6 md:px-12 bg-gray-900/50 backdrop-blur-sm">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">About Football101</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-gray-800/50 border border-gray-700 p-6 text-center rounded-xl">
                <FaUsers className="h-8 w-8 text-gray-400 mx-auto mb-3" />
                <h3 className="text-white font-semibold mb-2">Team Management</h3>
                <p className="text-gray-400 text-sm">Organize and track team performance</p>
              </div>
              <div className="bg-gray-800/50 border border-gray-700 p-6 text-center rounded-xl">
                <FaTrophy className="h-8 w-8 text-gray-400 mx-auto mb-3" />
                <h3 className="text-white font-semibold mb-2">League Tracking</h3>
                <p className="text-gray-400 text-sm">Monitor standings and statistics</p>
              </div>
              <div className="bg-gray-800/50 border border-gray-700 p-6 text-center rounded-xl">
                <FaBullseye className="h-8 w-8 text-gray-400 mx-auto mb-3" />
                <h3 className="text-white font-semibold mb-2">Match Recording</h3>
                <p className="text-gray-400 text-sm">Log results and scores easily</p>
              </div>
              <div className="bg-gray-800/50 border border-gray-700 p-6 text-center rounded-xl">
                <FaFutbol className="h-8 w-8 text-gray-400 mx-auto mb-3" />
                <h3 className="text-white font-semibold mb-2">Real-time Updates</h3>
                <p className="text-gray-400 text-sm">Stay current with live data</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section ref={exploreRef} className="py-24 px-6 md:px-12">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <div className="w-24 h-1 bg-gradient-to-r from-gray-700 to-black mx-auto mt-8"></div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {features.map((feature) => (
              <Link key={feature.path} to={feature.path} className="group block">
                <div
                  className={`bg-gray-900/50 border border-gray-700 hover:border-gray-600 transition-all duration-300 transform hover:-translate-y-2 hover:shadow-2xl ${feature.hoverColor} overflow-hidden rounded-xl`}
                >
                  <div className="p-8 text-center relative">
                    {/* Background gradient */}
                    <div
                    ...
                    <div className="relative z-10">
                      <div
                        className={`w-16 h-16 rounded-full bg-gradient-to-r ${feature.color} border border-gray-600 flex items-center justify-center mx-auto mb-6 shadow-lg group-hover:scale-110 transition-transform duration-300`}
                      >
                        <div className="text-white">{feature.icon}</div>
                      </div>

                      <h3 className="text-2xl font-bold text-white mb-4 group-hover:text-gray-300 transition-all duration-300">
                        {feature.title}
                      </h3>
                      ...
                      <div className="flex items-center justify-center text-gray-400 group-hover:text-gray-300 transition-colors duration-300">
                        <span className="font-semibold">Explore</span>
                        <FaArrowRight className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform duration-300" />
                      </div>
                    </div>
